/*
  ...
  This migration adds a new table to store persistent star ratings for movie reviews.
  The ratings are restricted to specific values (3.5, 4.0, 4.5, 5.0) to ensure consistency.
*/
